      ...
      <div className="flex items-center">
        <a href="/" className="relative flex items-center">
          ...
          <svg
            ...
            height={34}
            aria-hidden="true"
            className="absolute -start-0.75 top-1/2 -translate-y-1/2 transition-opacity duration-500 opacity-0"
          >
            <use
              href="/cdn/assets/sprites-core-btjmrd1b.svg#55180d"
              fill="currentColor"
            />
          </svg>
        </a>
